...
abstract class ABSolanaChains {
  ///获取Solana网络信息
  factory ABSolanaChains() =>
      ABWeb3CoreModule.instance.getWeb3Network(networkId: 111);

  const ABSolanaChains.internal();

  ///Solana网络唯一值
  final ABWeb3NetworkId = 111;
  ...
  /// [tokenAddress] 代币地址
  /// return 余额
  Future<BigInt> getSplTokenBalance({
  ...
  /// [tx] 交易
  /// return 签名后的交易
  Future<ABWeb3SOLSignedTransaction> signTx({
    required ABWeb3SOLTransaction tx,
  ...
  /// [tx] 交易
  /// return 已发送的交易
  Future<ABWeb3SOLSentTransaction> sendTx({
    required ABWeb3SOLSignedTransaction tx,
  });
