...
class ParseRequestOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ParseRequestOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.WalletConnect.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$9.SigningInput>(3, _omitFieldNames ? '' : 'binance', subBuilder: $9.SigningInput.create)
    ..aOM<$10.SigningInput>(4, _omitFieldNames ? '' : 'solana', subBuilder: $10.SigningInput.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set binance($9.SigningInput v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set solana($10.SigningInput v) { setField(4, v); }
  @$pb.TagNumber(4)
