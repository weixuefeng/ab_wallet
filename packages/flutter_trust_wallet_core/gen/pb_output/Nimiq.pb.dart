...
class SigningInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SigningInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Nimiq.Proto'), createEmptyInstance: create)
    ...
    ..e<NetworkId>(6, _omitFieldNames ? '' : 'networkId', $pb.PbFieldType.OE, defaultOrMaker: NetworkId.UseDefault, valueOf: NetworkId.valueOf, enumValues: NetworkId.values)
  ...
  @$pb.TagNumber(6)
  set networkId(NetworkId v) { setField(6, v); }
  @$pb.TagNumber(6)
