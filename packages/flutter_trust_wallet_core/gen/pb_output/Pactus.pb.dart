...
enum TransactionMessage_Payload {
  transfer, 
  bond, 
  notSet
}
...
class TransactionMessage extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, TransactionMessage_Payload> _TransactionMessage_PayloadByTag = {
    10 : TransactionMessage_Payload.transfer,
    11 : TransactionMessage_Payload.bond,
    0 : TransactionMessage_Payload.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Pactus.Proto'), createEmptyInstance: create)
    ..oo(0, [10, 11])
    ..a<$core.int>(1, _omitFieldNames ? '' : 'lockTime', $pb.PbFieldType.OU3)
    ..aInt64(2, _omitFieldNames ? '' : 'fee')
    ..aOS(3, _omitFieldNames ? '' : 'memo')
    ..aOM<TransferPayload>(10, _omitFieldNames ? '' : 'transfer', subBuilder: TransferPayload.create)
    ..aOM<BondPayload>(11, _omitFieldNames ? '' : 'bond', subBuilder: BondPayload.create)
  ...
  TransactionMessage_Payload whichPayload() => _TransactionMessage_PayloadByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(10)
  set transfer(TransferPayload v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set bond(BondPayload v) { setField(11, v); }
  @$pb.TagNumber(11)
...
class TransferPayload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransferPayload', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Pactus.Proto'), createEmptyInstance: create)
...
class BondPayload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BondPayload', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Pactus.Proto'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'sender')
    ..aOS(2, _omitFieldNames ? '' : 'receiver')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BondPayload copyWith(void Function(BondPayload) updates) => super.copyWith((message) => updates(message as BondPayload)) as BondPayload;
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SigningInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Pactus.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'privateKey', $pb.PbFieldType.OY)
    ..aOM<TransactionMessage>(2, _omitFieldNames ? '' : 'transaction', subBuilder: TransactionMessage.create)
    ..hasRequiredFields = false
  ;
...
class SigningOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SigningOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Pactus.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'transactionId', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'signedTransactionData', $pb.PbFieldType.OY)
  ...
  @$pb.TagNumber(2)
  set signedTransactionData($core.List<$core.int> v) { $_setBytes(1, v); }
  @$pb.TagNumber(2)
