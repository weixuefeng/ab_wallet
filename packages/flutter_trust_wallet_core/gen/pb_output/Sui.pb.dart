...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(10)
  set rawJson($core.String v) { $_setString(9, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set gasBudget($fixnum.Int64 v) { $_setInt64(10, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set referenceGasPrice($fixnum.Int64 v) { $_setInt64(11, v); }
  @$pb.TagNumber(13)
...
class MessageSigningInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MessageSigningInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Sui.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'privateKey', $pb.PbFieldType.OY)
...
class MessageSigningOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MessageSigningOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Sui.Proto'), createEmptyInstance: create)
...
class MessageVerifyingInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MessageVerifyingInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Sui.Proto'), createEmptyInstance: create)
