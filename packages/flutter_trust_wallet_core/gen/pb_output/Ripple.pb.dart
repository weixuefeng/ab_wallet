...
class OperationPayment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OperationPayment', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Ripple.Proto'), createEmptyInstance: create)
    ...
    ..a<$core.int>(4, _omitFieldNames ? '' : 'destinationTag', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set destinationTag($core.int v) { $_setUnsignedInt32(3, v); }
  @$pb.TagNumber(4)
...
class OperationEscrowCreate extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set cancelAfter($core.int v) { $_setUnsignedInt32(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set finishAfter($core.int v) { $_setUnsignedInt32(4, v); }
  @$pb.TagNumber(5)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(25)
  set sourceTag($core.int v) { $_setUnsignedInt32(17, v); }
  @$pb.TagNumber(25)
