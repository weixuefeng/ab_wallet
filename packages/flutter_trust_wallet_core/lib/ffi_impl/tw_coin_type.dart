...
abstract class TWCoinType {
  ...
  static const int TWCoinTypeNewChain = 1642;

  /// Returns the blockchain for a coin type.
  ///
  /// \param coin A coin type
  /// \return blockchain associated to the given coin type
  static int TWCoinTypeBlockchain(int coin) {
  ...
  static int TWCoinTypePurpose(int coin) {
  ...
  static int TWCoinTypeCurve(int coin) {
  ...
  static int TWCoinTypeXpubVersion(int coin) {
  ...
  static int TWCoinTypeXprvVersion(int coin) {
  ...
  static bool TWCoinTypeValidate(int coin, Pointer<Utf8> address) {
  ...
  static Pointer<Utf8> TWCoinTypeDerivationPath(int coin) {
  ...
  static int TWCoinTypeHRP(int coin) {
  ...
  static int TWCoinTypeP2pkhPrefix(int coin) {
  ...
  static int TWCoinTypeP2shPrefix(int coin) {
  ...
  static int TWCoinTypeStaticPrefix(int coin) {
  ...
  static Pointer<Utf8> TWCoinTypeChainId(int coin) {
  ...
  static int TWCoinTypeSlip44Id(int coin) {
  ...
  static int TWCoinTypeSS58Prefix(int coin) {
  ...
  static int TWCoinTypePublicKeyType(int coin) {
