...
class SwapOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SwapOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.THORChainSwap.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$5.SigningInput>(4, _omitFieldNames ? '' : 'bitcoin', subBuilder: $5.SigningInput.create)
    ..aOM<$6.SigningInput>(5, _omitFieldNames ? '' : 'ethereum', subBuilder: $6.SigningInput.create)
    ..aOM<$9.SigningInput>(6, _omitFieldNames ? '' : 'binance', subBuilder: $9.SigningInput.create)
    ..aOM<$7.SigningInput>(7, _omitFieldNames ? '' : 'cosmos', subBuilder: $7.SigningInput.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set bitcoin($5.SigningInput v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set ethereum($6.SigningInput v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set binance($9.SigningInput v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set cosmos($7.SigningInput v) { setField(7, v); }
  @$pb.TagNumber(7)
