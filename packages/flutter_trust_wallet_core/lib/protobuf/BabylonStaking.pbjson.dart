...
const StakingInfo$json = {
  '1': 'StakingInfo',
  '2': [
    {'1': 'staker_public_key', '3': 1, '4': 1, '5': 12, '10': 'stakerPublicKey'},
    {'1': 'finality_provider_public_key', '3': 2, '4': 1, '5': 12, '10': 'finalityProviderPublicKey'},
    {'1': 'staking_time', '3': 3, '4': 1, '5': 13, '10': 'stakingTime'},
    {'1': 'covenant_committee_public_keys', '3': 4, '4': 3, '5': 12, '10': 'covenantCommitteePublicKeys'},
...
const InputBuilder$json = {
  '1': 'InputBuilder',
  '3': [InputBuilder_StakingTimelockPath$json, InputBuilder_StakingUnbondingPath$json, InputBuilder_StakingSlashingPath$json, InputBuilder_UnbondingTimelockPath$json, InputBuilder_UnbondingSlashingPath$json],
};
...
const InputBuilder_StakingTimelockPath$json = {
  ...
  '2': [
    {'1': 'params', '3': 1, '4': 1, '5': 11, '6': '.TW.BabylonStaking.Proto.StakingInfo', '10': 'params'},
  ],
};
...
const InputBuilder_StakingUnbondingPath$json = {
  ...
  '2': [
    {'1': 'params', '3': 1, '4': 1, '5': 11, '6': '.TW.BabylonStaking.Proto.StakingInfo', '10': 'params'},
    {'1': 'covenant_committee_signatures', '3': 2, '4': 3, '5': 11, '6': '.TW.BabylonStaking.Proto.PublicKeySignature', '10': 'covenantCommitteeSignatures'},
  ],
};
...
const InputBuilder_StakingSlashingPath$json = {
  ...
  '2': [
    {'1': 'params', '3': 1, '4': 1, '5': 11, '6': '.TW.BabylonStaking.Proto.StakingInfo', '10': 'params'},
    {'1': 'finality_provider_signature', '3': 2, '4': 1, '5': 11, '6': '.TW.BabylonStaking.Proto.PublicKeySignature', '10': 'finalityProviderSignature'},
  ],
};
...
const OutputBuilder$json = {
  '1': 'OutputBuilder',
  '3': [OutputBuilder_StakingOutput$json, OutputBuilder_UnbondingOutput$json, OutputBuilder_OpReturn$json],
};
...
const OutputBuilder_OpReturn$json = {
  ...
  '2': [
    ...
    {'1': 'staker_public_key', '3': 2, '4': 1, '5': 12, '10': 'stakerPublicKey'},
    {'1': 'finality_provider_public_key', '3': 3, '4': 1, '5': 12, '10': 'finalityProviderPublicKey'},
