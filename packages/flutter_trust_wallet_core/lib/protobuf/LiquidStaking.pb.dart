...
class Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.LiquidStaking.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$6.SigningInput>(2, _omitFieldNames ? '' : 'ethereum', subBuilder: $6.SigningInput.create)
    ..aOM<$7.SigningInput>(3, _omitFieldNames ? '' : 'cosmos', subBuilder: $7.SigningInput.create)
    ..aOM<$8.SigningInput>(4, _omitFieldNames ? '' : 'aptos', subBuilder: $8.SigningInput.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set ethereum($6.SigningInput v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set cosmos($7.SigningInput v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set aptos($8.SigningInput v) { setField(4, v); }
  @$pb.TagNumber(4)
