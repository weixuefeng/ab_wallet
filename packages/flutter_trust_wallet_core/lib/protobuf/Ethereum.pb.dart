...
class SigningInput extends $pb.GeneratedMessage {
  factory SigningInput({
    ...
    if (useNist256p1Sign != null) {
      $result.useNist256p1Sign = useNist256p1Sign;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SigningInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Ethereum.Proto'), createEmptyInstance: create)
    ...
    ..aOB(13, _omitFieldNames ? '' : 'useNist256p1Sign')
    ..hasRequiredFields = false
  ;
  ...
  /// only for 'new'
  @$pb.TagNumber(13)
  $core.bool get useNist256p1Sign => $_getBF(12);
  @$pb.TagNumber(13)
  set useNist256p1Sign($core.bool v) { $_setBool(12, v); }
  @$pb.TagNumber(13)
  $core.bool hasUseNist256p1Sign() => $_has(12);
  @$pb.TagNumber(13)
  void clearUseNist256p1Sign() => clearField(13);
}
