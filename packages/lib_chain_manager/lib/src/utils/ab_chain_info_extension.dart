...
extension ABChainInfoExtension on ABChainInfo {
  ...
  static ABChainInfo fromJson(String jsonString) {
    ...
    final mainTokenInfo = json['mainTokenInfo'] != null
        ? ABTokenInfoAdapter(
      ...
      contractInfo: json['mainTokenInfo']['contractInfo'] != null
          ? ABContractInfoAdapter(
          json['mainTokenInfo']['contractInfo']['contractAddress'] ??
              '')
          : null,
      ordinalsInfo: json['mainTokenInfo']['ordinalsInfo'] != null
    ...
    final endpoints = json['endpoints'] != null
        ? ABChainEndpoints(
  ...
  String toJson() {
    ...
    final mainTokenInfoJson = mainTokenInfo != null
        ? {
      ...
      'contractInfo': mainTokenInfo!.contractInfo != null
          ? {
        'contractAddress':
        mainTokenInfo!.contractInfo!.contractAddress,
      }
          : null,
      'ordinalsInfo': mainTokenInfo!.ordinalsInfo != null
          ? {
    ...
    final endpointsJson = endpoints != null
        ? {
